...
<div class="container"> 
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    <div class="row mt-4">
        <div class="col-md-6">
            <a href="<?= base_url();?>mahasiswa/tambah"class="btn btn-danger"> Tambah Data</a>
    </div>
    </div>
    <div class="row mt-3">
<div class="col-md-6">
...
<?php if(empty($mahasiswa)):?>
    <div class="alert alert-danger role="alert">DATA MAHASISWA TIDAK DI TEMUKAN</div>
<?PHP endif; ?>
...
<li class="list-group-item">
    ...
    class="badge badge-danger float-right" onclick="return confirm('Yakin Data ini akan di hapus')";>Hapus</a>
